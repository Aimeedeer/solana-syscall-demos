...
pub fn demo_pubsub_client_async(config: &Config, rpc_client: RpcClient) -> Result<()> {
    let rt = Runtime::new()?;
        ...
        join_handles.push((
            ...
            tokio::spawn({
                ...
                async move {
                    ...
                    ready_sender.send(()).expect("channel");
                    unsubscribe_sender
                        .send((slot_updates_unsubscribe, "slot_updates"))
                        .map_err(|e| format!("{}", e))
                        .expect("channel");
                    drop((ready_sender, unsubscribe_sender));
        ...
        join_handles.push((
            ...
            tokio::spawn({
                ...
                async move {
                    ...
                    ready_sender.send(()).expect("channel");
                    unsubscribe_sender
                        .send((program_unsubscribe, "program"))
                        .map_err(|e| format!("{}", e))
                        .expect("channel");
                    drop((ready_sender, unsubscribe_sender));
        ...
        join_handles.push((
            ...
            tokio::spawn({
                ...
                async move {
                    ...
                    ready_sender.send(()).expect("channel");
                    unsubscribe_sender
                        .send((account_unsubscribe, "account"))
                        .map_err(|e| format!("{}", e))
                        .expect("channel");
                    drop((ready_sender, unsubscribe_sender));
            ...
            join_handles.push((
                ...
                tokio::spawn({
                    ...
                    async move {
                        ...
                        ready_sender.send(()).expect("channel");
                        unsubscribe_sender
                            .send((signature_unsubscribe, "signature"))
                            .map_err(|e| format!("{}", e))
                            .expect("channel");
                        drop((ready_sender, unsubscribe_sender));
